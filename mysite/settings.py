...
ALLOWED_HOSTS = ['ec2-34-225-210-97.compute-1.amazonaws.com','ec2-34-225-210-97.compute-1.amazonaws.com:8000/','127.0.0.1']
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'mysite/core/static')
]
